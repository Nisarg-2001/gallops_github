                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <h3 class="card-header mb-3 text-center">Return Report</h3>
                            ...
                            <div class="card-body">
                                ...
                                <caption class="text-center " style="caption-side:top;">Gallops Food Plaza (Store)<br>
                                    <b>Report: Report Report {{(isset($from)) ? 'From: '.date('d-m-Y',strtotime($from)).' To '.date('d-m-Y',strtotime($to)) : '' }}</b></caption>
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <th>vendor Name</th>
                                    ...
                                    <?php $c++; 
                                          $totamt +=  (isset($info['issued']) && !empty($info['issued'])) ? number_format(($info['issued']->qty)*($info['issued']->unit_price),2) : '0.00' ;  ?>
                                    @endforeach
                                    @endif
                                    </tbody>
                                    <tfoot>
                                        <tr align="right">
                                            ...
                                            <th>{{(isset($totamt)) ? number_format($totamt,2) : '0.00' }}</th>
