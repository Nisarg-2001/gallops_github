              ...
              <div class="card-body">
                <form action="{{ url('order/post') }}" method="post" id="orderForm">
                  ...
                  <table id="example1" class="table table-bordered table-hover order-table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <?php /* ?>
                          <input type='text' value="<?php echo $xx[$i]['I_ItemPrice'];?>" id='NetPrice_<?php echo $i+1;?>' name='NetPrice[]' class='form-control filterme' readonly>
                          <?php */ ?>
                        </td>
                        <td>
                          <?php /* ?>
                          <input type='number' value="<?php echo $xx[$i]['I_ItemQty'];?>" id='Qty_<?php echo $i+1;?>' name='Qty[]' class='form-control filterme' min='1' max='9999'  onkeyup="updateAmount(<?php echo $xx[$i]['I_ItemID'];?>,<?php echo $i+1;?>)" onchange="updateAmount(<?php echo $xx[$i]['I_ItemID'];?>,<?php echo $i+1;?>)" readonly>
                          <?php */ ?>
                        </td>
                        <td>
                          <?php /* ?>
                  ...
                  <table class="table table-bordered table-hover " id="taxTotal" >
                    <tr>
                      <td width="85%" align="right" style="padding-right:20px;"> <b>Sub Total</b></td>
                    ...
                    <tr>
                      <td width="85%" align="right" style="padding-right:20px;"><b>Total Amount (₹)</b> </td>
                      <td width="15%" align="right"> <b><span id="TotalAmt">0.00</span></b></td>
                    </tr>
                  </table>
