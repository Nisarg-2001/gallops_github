...
<head>
  ...
  <title>Gallops | Outward Invoice</title>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $data->name }}</td>
              <td>{{ $data->iqty}}</td>
              <td>{{ $data->iqty}}&nbsp; {{$data->unit_name}}</td>
             <td>{{ $data->iprice}} / {{$data->unit_name}}</td>
             <td>{{ ($data->iqty * $data->iprice)}}</td>
              
            </tr>
             <?php $total+=($data->iqty * $data->iprice); ?>
             <?php $c++; ?>
            @endforeach
          </tbody>
          <tfoot>
