                ...
                <form action="{{ url('assign_product/post') }}" method="post" id="assignProductForm">
                  ...
                  <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="vendor_id" id="vendor_id">
                          <option value="">Select Vendor</option>
                          @foreach($vendor as $v)
                          <option value="{{$v->id}}" {{ (isset($data->vendor_id) && $data->vendor_id == $v->id ) ? 'selected' : '' }} {{(Request::get("vendor")) ? 'selected' : ''}}>
                            {{ $v->name }}
                          </option>
                          @endforeach
                        </select>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-4 col-lg-4">
                      <div class="form-group">
                        <label>Price (₹) *</label>
                        <input type="text" class="form-control" name="price" value="{{ (isset($data->price) && !empty($data->price)) ? $data->price : '' }}" placeholder="Product Price">
                        @error('name')
                  ...
                  <div class="col-12 col-md-3 col-lg-3">
                    <div class="form-group">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="is_default" value="1" {{ $yesChecked }}>
                        <label class="form-check-label mr-5" for="flexRadioDefault1">
                          Yes
                        </label>
                        <input class="form-check-input" type="radio" name="is_default" value="0" {{ $noChecked }}>
